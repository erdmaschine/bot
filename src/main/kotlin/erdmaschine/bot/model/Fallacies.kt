...
val Fallacies = mapOf(
    ...
    "personal-incredulity" to "Stating the opposing argument is wrong because you don't like it",
    "red-herring" to "Attempt to derail the conversation with irrelevant points",
    "relative-privation" to "Just because someone else is worse, doesn't make you right",
    ...
    "whataboutism" to "Attempt to discredit claim by pointing to something else without",
)
